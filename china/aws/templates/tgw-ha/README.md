    ...
    <tbody>
        <tr>
           ...
           Deploys two Security Gateways, each in a different Availability Zone, configured for Transit Gateway.<br/><br/>For more details, refer to <a href="https://sc1.checkpoint.com/documents/IaaS/WebAdminGuides/EN/CP_CloudGuard_for_AWS_Transit_Gateway_High_Availability/Default.htm">CloudGuard Transit Gateway High Availability for AWS R80.40 Administration Guide</a>.
            ...
            <td><a href="https://console.amazonaws.cn/cloudformation/home#/stacks/create/review?templateURL=https://cgns-china-cft.s3.us-east-1.amazonaws.com/cluster/tgw-ha-master.yaml&stackName=Check-Point-TGW-HA"><img src="../../images/launch.png"/></a></td>
        </tr>
        <tr>
            ...
            <td><a href="https://console.amazonaws.cn/cloudformation/home#/stacks/create/review?templateURL=https://cgns-china-cft.s3.us-east-1.amazonaws.com/cluster/tgw-ha.yaml&stackName=Check-Point-TGW-HA"><img src="../../images/launch.png"/></a></td>
        </tr>
    </tbody>
</table>
<br/>
