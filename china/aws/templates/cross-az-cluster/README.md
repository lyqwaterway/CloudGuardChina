...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><a href="https://console.amazonaws.cn/cloudformation/home#/stacks/create/review?templateURL=https://cgns-china-cft.s3.us-east-1.amazonaws.com/cluster/cross-az-cluster-master.yaml&stackName=Check-Point-Cross-AZ-Cluster"><img src="../../images/launch.png"/></a></td>
        </tr>
        <tr>
            <td width="40%">Deploys a Cross Availability Zone Cluster of Security Gateways into an existing VPC.</td>
            <td><a href="https://console.amazonaws.cn/cloudformation/home#/stacks/create/review?templateURL=https://cgns-china-cft.s3.us-east-1.amazonaws.com/cluster/cross-az-cluster.yaml&stackName=Check-Point-Cross-AZ-Cluster"><img src="../../images/launch.png"/></a></td>
        </tr>
    </tbody>
</table>
<br/>
